...
static bool test_BB_lowBandHoldsPreviousPermit() {
  ...
  const bool ok = controller.update(1500U, 900U);
...
static bool test_BB_lowOffTurnsCompressorOff() {
  ...
  controller.update(2500U, 900U);
  const bool ok = controller.update(900U, 900U);
...
static bool test_BB_highBandHoldsPreviousInhibit() {
  ...
  const bool ok = controller.update(2500U, 1100U);
...
static bool test_BB_singleInhibitStatesReturnTrue() {
  ...
  const bool lowInhibitHighPermit = controller.update(900U, 900U);
  ...
  const bool lowPermitHighInhibit = controller.update(2500U, 1300U);
